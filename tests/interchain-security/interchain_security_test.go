...
import (
	...
	appConsumer "github.com/kalpatech-team/kalpa/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and kalpa consumer chain
